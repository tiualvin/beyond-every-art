...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"payload_mcp_tool_draft_article" boolean DEFAULT true,
  	"payload_mcp_tool_read_article_markdown" boolean DEFAULT true,
  	"payload_mcp_tool_update_article_markdown" boolean DEFAULT true,
